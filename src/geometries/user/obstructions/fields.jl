...
property_fields = (
    ...
    Field{Float64}(:size_scale, "Size of the smallest obstructions. If not set explicitly, this will be determined by the minimum radius or distance between objects (see `size_scale`).", per_surface=true),
)
