...
import .Properties: R1, R2, off_resonance, permeability, surface_relaxation, surface_density, dwell_time, max_timestep_sticking, MRIProperties, max_permeability_non_inf
