...
_requires_inside(::Type{Tuple{}}) = Val(false)

_requires_inside(::Type{P}) where {P<:Tuple} =
    _requires_inside(
        get_intersection_params_requires_inside(Base.tuple_type_head(P)),
        Base.tuple_type_tail(P),
    )
